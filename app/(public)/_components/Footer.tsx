  ...
  return (
    <footer className="relative border-t border-white/10 bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -right-32 top-0 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl" />
      </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="group flex items-center gap-2.5">
              <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 font-bold text-white shadow-lg shadow-blue-500/30">
                F
              </div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-slate-400">
              Bangladesh’s trusted home services marketplace.  
              Book verified technicians in minutes — fast, safe & affordable.
            </p>
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex size-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-400 transition-all hover:border-blue-500/40 hover:bg-blue-500/10 hover:text-blue-400"
              >
                {social.icon}
              </a>
            ))}
